...
//open class DatomicConfiguration {
//    @Bean //(destroyMethod = "release") <-- appears unnecessary when using datomic
//    open fun connection(@Value("\${datomic.uri}") uri: String): Connection {
